...
This partial gives dense guidance for approaching the landing pad, slowing
down, staying upright, and making leg contact. It intentionally omits the
engine penalties and terminal landed/crashed bonuses from the full reward.
"""
...
class LunarLanderApproachPartial:
    ...
    def step(self, obs, action, next_obs, true_reward, terminated, truncated, info) -> PartialRewardStep:
        ...
        return PartialRewardStep(
            ...
            components={
                "approach_shaping_delta": float(shaping_delta),
                "engine_penalty_omitted": 0.0,
                "terminal_reward_omitted": 0.0,
            },
        )
...
def register(registry) -> None:
    registry.register(
        ...
        component_keys=(
            "approach_shaping_delta",
            "engine_penalty_omitted",
            "terminal_reward_omitted",
        ),
    )
