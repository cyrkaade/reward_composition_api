...
This keeps the survival signal and only rewards forward progress up to a
per-step cap. It intentionally omits control cost and does not distinguish
between moderate and very fast hopping once the cap is reached.
"""
